    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.CharField(blank=True, help_text='Group tickets that belong to the same checkout/payment.', max_length=64, null=True)),
                ('status', models.CharField(blank=True, help_text='PENDING / ISSUED / USED. Left null for legacy tickets.', max_length=20, null=True)),
                ('qr_code', models.CharField(blank=True, help_text='QR payload or unique ticket code.', max_length=160, null=True, unique=True)),
